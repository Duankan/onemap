...
public class TempleExcelUtil {
	private static Logger logger = Logger.getLogger(TempleExcelUtil.class);
	...
	public void createExcel(List<Object[]> list, HttpServletResponse response, HttpServletRequest request,
		...
		try {
			...
			if (tempType == 0) {
				...
				// firstrow.createCell((short) 0).setCellValue(new
				// HSSFRichTextString("序号"));
