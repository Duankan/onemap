 ...
 * @author： luxiaolin
 * @date： 2017年9月14日
 * @description：生成统计图表工具类
 * =====================================
 */
public class ChartUtils {
	private static String NO_DATA_MSG = "数据加载失败";
	private static Font FONT = new Font("宋体", Font.PLAIN, 12);
	public static Color[] CHART_COLORS = { new Color(31, 129, 188), new Color(92, 92, 97), new Color(144, 237, 125), new Color(255, 188, 117), new Color(153, 158, 255),
			new Color(255, 117, 153), new Color(253, 236, 109), new Color(128, 133, 232), new Color(158, 90, 102), new Color(255, 204, 102) };// 颜色
	...
	public static void setChartTheme() {
		...
		// 绘制器颜色源
		DefaultDrawingSupplier drawingSupplier = new DefaultDrawingSupplier(CHART_COLORS, CHART_COLORS, OUTLINE_PAINT_SEQUENCE, DefaultDrawingSupplier.DEFAULT_STROKE_SEQUENCE,
	...
	// createDefaultCategoryDataset(Vector<Serie> series, String[] categories) {
	// DefaultCategoryDataset dataset = new DefaultCategoryDataset();
	//
	// for (Serie serie : series) {
	// String name = serie.getName();
	// Vector<Object> data = serie.getData();
	// if (data != null && categories != null && data.size() ==
	// categories.length) {
